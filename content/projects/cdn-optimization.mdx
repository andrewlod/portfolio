...
- CSP was left out on purposes as different services depend on different origins, so those policies were still application-specific
...
**Next Project:** [Cost Optimization →](/projects/cost-optimization)